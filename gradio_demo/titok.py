import gradio as gr
from any_tokenizers import TiTokImageTokenizer, ImagePreprocessConfig
...
# 토크나이저 초기화
model_path = "yucornetto/tokenizer_titok_l32_imagenet"
tokenizer = TiTokImageTokenizer.from_pretrained(model_path)
